      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-white mb-2">Get Started with BidEngine</h1>
            <p className="text-gray-400">Create your account to start winning more bids</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500 text-xs mb-4">Trusted by businesses in FM, infrastructure & public sector</p>
